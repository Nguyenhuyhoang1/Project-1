import { PaymentMethods, InfoCustomer } from "../Data"
  ...
  return (
    <form className="PaymentDetail">
      ...
      <div className="Form__CheckOut" >
        ...
        <Button style={{ background: "#FFF", color: "#000", boxShadow: "none" }} type="primary" onClick={showModal}>
          <QuestionOutlined />
        </Button>
        ...
        <div className="icon-check"><CheckCircleOutlined /></div>
        <Button className="btn-info" style={{ background: "#FFF", color: "#000", boxShadow: "none" }} type="primary" onClick={showModal}>
          <QuestionOutlined />
        </Button>
        <Modal title="Giới thiệu và hướng dẫn nhập mã giảm giá" open={isModalOpen} onOk={handleOk} onCancel={handleCancel}>
          <hr />
      ...
      <div className="PaymentMethod">
        ...
        {PaymentMethods.map((item) => (
          <a href=""><img className="ImgPayment" src={item.img} alt="" /></a>
        ))}
      </div>
